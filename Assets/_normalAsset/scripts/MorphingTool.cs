...
public class MorphingTool : MonoBehaviour
{
    ...
    /// <returns></returns>
    public float[] GetFloat4(float _v0 = 0, float _v1 = 0, float _v2 = 0, float _v3 = 0)
    {
    ...
    /// <returns></returns>
    public Vector3 GetData(Vector3 _v3, ValueData _valueData)
    {
    ...
    /// <param name="_valueData"></param>
    /// <returns></returns>
    public Quaternion GetData(Quaternion _v4, ValueData _valueData)
    {
    ...
    /// <param name="_valueData"></param>
    /// <returns></returns>
    public float GetData(ValueData _valueData)
    {
    ...
    /// <param name="_valueData"></param>
    /// <returns></returns>
    public Color GetData(Color _v4,ValueData _valueData)
    {
        _v4.r = _valueData.data[0];
        _v4.b = _valueData.data[1];
        _v4.g = _valueData.data[2];
    ...
    //public void SetValue(int _index, ValueData _value)
    //{
